...
//   item.trader.TradeList.Select('2017-02', '2019-02').TotalIncome - item.trader.TradeList.Select('2017-02', '2019-02').TotalAppreciation,
...
const strategy = new Cross2LineReady(dayPrice.MA(10), dayPrice.MA(22));
